...
class IatRecorder {
  ...
  onWillStatusChange?: (oldStatus: Status, newStatus: Status) => void

  constructor({ language, accent, appId }: IatRecorderProps) {
  ...
  setStatus(status: Status) {
    if (this.onWillStatusChange && this.status && this.status !== status) {
